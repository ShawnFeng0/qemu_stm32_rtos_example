...
// Copy from boost/intrusive/circular_list_algorithms.hpp
...
//! forming a circular doubly linked list. An empty circular list is formed by a
//! node whose pointers point to itself.
//!
//! circular_list_algorithms is configured with a NodeTraits class, which
//! encapsulates the information about the node to be manipulated. NodeTraits
...
public:
  ...
  //!
  //! <b>Throws</b>: Nothing.
  inline static void init(node_ptr this_node) noexcept {
  ...
  //!
  //! <b>Throws</b>: Nothing.
  inline static bool inited(const const_node_ptr &this_node) noexcept {
    return !NodeTraits::get_next(this_node);
  }

  //! <b>Effects</b>: Constructs an empty list, making this_node the only
  //!   node of the circular list:
  //!  <tt>NodeTraits::get_next(this_node) ==
  //!  NodeTraits::get_previous(this_node)
  //!  == this_node</tt>.
  //!
  //! <b>Complexity</b>: Constant
  //!
  //! <b>Throws</b>: Nothing.
  inline static void init_header(node_ptr this_node) noexcept {
    NodeTraits::set_next(this_node, this_node);
    NodeTraits::set_previous(this_node, this_node);
  }

  //! <b>Requires</b>: this_node must be in a circular list or be an empty
  //! circular list.
  //!
  //! <b>Effects</b>: Returns true is "this_node" is the only node of a circular
  //! list:
  ...
  //!
  //! <b>Throws</b>: Nothing.
  inline static bool unique(const const_node_ptr &this_node) noexcept {
  ...
  //! circular list.
  //!
  //! <b>Effects</b>: Returns the number of nodes in a circular list. If the
  //! circular list
  //!  is empty, returns 1.
  //!
  ...
  //!
  //! <b>Throws</b>: Nothing.
  static std::size_t count(const const_node_ptr &this_node) noexcept {
    std::size_t result = 0;
  ...
  //!
  //! <b>Throws</b>: Nothing.
  inline static node_ptr unlink(node_ptr this_node) noexcept {
    node_ptr next(NodeTraits::get_next(this_node));
  ...
  //!
  //! <b>Throws</b>: Nothing.
  inline static void unlink(node_ptr b, node_ptr e) noexcept {
    if (b != e) {
  ...
  //!
  //! <b>Throws</b>: Nothing.
  inline static void link_before(node_ptr nxt_node,
                                 node_ptr this_node) noexcept {
  ...
  //!
  //! <b>Throws</b>: Nothing.
  inline static void link_after(node_ptr prev_node,
                                node_ptr this_node) noexcept {
  ...
  //!   other_nodes position in the second circular list and the other_node is
  //!   inserted in this_node's position in the first circular list.
  //!
  //! <b>Complexity</b>: Constant
  //!
  //! <b>Throws</b>: Nothing.
  ...
  //    [b, e).
  //!
  //! <b>Effects</b>: Removes the nodes from [b, e) range from their circular
  //! list and inserts
  ...
  //!   If p == i or p == NodeTraits::get_next(i), this function is a null
  //!   operation.
  //!
  //! <b>Complexity</b>: Constant
  //!
  ...
  //! <b>Effects</b>: Moves the node p n positions towards the beginning of the
  //! list.
  //!
  //! <b>Throws</b>: Nothing.
  //!
  ...
  //!
  //! <b>Throws</b>: Nothing.
  static std::size_t distance(const const_node_ptr &f,
                              const const_node_ptr &l) noexcept {
    const_node_ptr i(f);
    std::size_t result = 0;
    while (i != l) {
      i = NodeTraits::get_next(i);
  ...
  template <class Pred>
  static void stable_partition(node_ptr beg, node_ptr end, Pred pred,
...
private:
  inline static void swap_prev(node_ptr this_node,
                               node_ptr other_node) noexcept {
    node_ptr temp(NodeTraits::get_previous(this_node));
    NodeTraits::set_previous(this_node, NodeTraits::get_previous(other_node));
    NodeTraits::set_previous(other_node, temp);
  }

  inline static void swap_next(node_ptr this_node,
                               node_ptr other_node) noexcept {
